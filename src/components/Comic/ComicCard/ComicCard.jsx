            ...
            <Card.Body>
                ...
                <div className="icons-card">
                    <Link to={`/comicDetails/${_id}`}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" class="bi bi-book-half" viewBox="0 0 16 16">
                    ...
                    {owner !== user?._id &&
                        <>
                            <div className={(isFav) ? 'hide' : ''}>
                                <svg onClick={handleAddFavs} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" class="bi bi-suit-heart" viewBox="0 0 16 16">
                            ...
                            <div className={(isFav) ? '' : 'hide'}>
                                ...
                                <svg onClick={handleRemoveFavs} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-suit-heart-fill" viewBox="0 0 16 16">
                    ...
                    {owner === user?._id &&
                        <>
                            ...
                            <div className={(forSale) ? 'hide' : ''}>
                                <svg onClick={handleAvailabilityOn} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-basket3" viewBox="0 0 16 16">
                            ...
                            <div className={(forSale) ? '' : 'hide'}>
                                <svg onClick={handleAvailabilityOff} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-basket3-fill" viewBox="0 0 16 16">
